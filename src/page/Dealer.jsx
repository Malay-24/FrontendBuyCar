...
const Dealer = () => {
  ...
  const getAllData = async () => {
    fetch(`https://powerful-pig-purse.cyclic.app/dealer/car`, {
      method: "GET",
      headers: {
  ...
  const HandleUpadteproductDeatils = () => {
    fetch(`https://powerful-pig-purse.cyclic.app/dealer/update/${ProductID}`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: localStorage.getItem("cartoken"),
  ...
  const handleDelete = async (id) => {
    try {
      let r = await fetch(
        `https://powerful-pig-purse.cyclic.app/dealer/delete/${id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div style={{ marginBottom: "10%" }}>
      <Flex w={"90%"} m="auto" mb={"2%"} mt={"3%"}>
        ...
        <Box>
          <Select placeholder="Sort By Mileage" onChange={handleMileage}>
            <option value="asc">Ascending</option>
            <option value="desc">Descending</option>
          </Select>
        </Box>
      ...
      <Heading>Product Details of Dealer</Heading>
